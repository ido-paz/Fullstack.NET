            ...
            modelBuilder.Entity("Shop_FC_Summery.Models.UserOrder", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OrderId = 1,
                            Created = new DateTime(2023, 2, 8, 20, 37, 27, 643, DateTimeKind.Local).AddTicks(3902),
                            UserId = 1
                        },
                        new
                        {
                            OrderId = 2,
                            Created = new DateTime(2023, 2, 8, 20, 37, 27, 643, DateTimeKind.Local).AddTicks(3942),
                            UserId = 1
                        },
                        new
                        {
                            OrderId = 3,
                            Created = new DateTime(2023, 2, 8, 20, 37, 27, 643, DateTimeKind.Local).AddTicks(3944),
                            UserId = 1
                        },
                        new
                        {
                            OrderId = 4,
                            Created = new DateTime(2023, 2, 8, 20, 37, 27, 643, DateTimeKind.Local).AddTicks(3947),
                            UserId = 2
                        },
                        new
                        {
                            OrderId = 5,
                            Created = new DateTime(2023, 2, 8, 20, 37, 27, 643, DateTimeKind.Local).AddTicks(3949),
                            UserId = 2
                        });
                });
