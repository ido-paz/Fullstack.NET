...
import {
  ...
  useMounted,
  usePrevious
} from "./chunk-JHQESZB7.js";
import {
  Row_default
} from "./chunk-4KGN2Y6R.js";
import {
  require_react_dom
...
import {
  CardImg_default,
  Card_default
} from "./chunk-JNIT2PBH.js";
import {
  divWithClassName_default
} from "./chunk-NQXEOAA6.js";
...
var NavbarBrand = React36.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React37.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime38.jsx)(Collapse_default, {
...
var NavbarToggle = React38.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  return (0, import_jsx_runtime39.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime39.jsx)("span", {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react26.useMemo)(function() {
...
var OffcanvasToggling = React39.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime40.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React39.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames28.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
    })
  });
});
...
var OffcanvasHeader = React40.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime42.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React41.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const renderBackdrop = (0, import_react27.useCallback)((backdropProps) => (0, import_jsx_runtime42.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames30.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime42.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames30.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
  return (0, import_jsx_runtime44.jsxs)(import_jsx_runtime43.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime42.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React42.forwardRef((props, ref) => {
...
var Navbar = React43.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime46.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime46.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime46.jsx)(Component2, {
        ref,
        ...controlledProps,
        className: (0, import_classnames31.default)(className, bsPrefix, expand && expandClass, variant && `${bsPrefix}-${variant}`, bg && `bg-${bg}`, sticky && `sticky-${sticky}`, fixed && `fixed-${fixed}`)
      })
    })
  });
});
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime54.jsxs)(import_jsx_runtime53.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react34.cloneElement)(children, triggerProps), (0, import_jsx_runtime52.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var Pagination = React51.forwardRef(({
  ...
  return (0, import_jsx_runtime57.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames36.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames37.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var Spinner = React56.forwardRef(({
  ...
  return (0, import_jsx_runtime62.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames40.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
var ToastFade = React66.forwardRef((props, ref) => (0, import_jsx_runtime75.jsx)(Fade_default, {
  ...props,
  ref,
